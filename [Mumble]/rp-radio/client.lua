...
Radio.Labels = {        
	{ "FRZL_RADIO_HELP", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Göm radio.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Radion är ~g~På~s~.~n~~" .. radioConfig.Controls.Decrease.Name .. "~ eller ~" .. radioConfig.Controls.Increase.Name .. "~ för att byta frekvens~n~~" .. radioConfig.Controls.Input.Name .. "~ Välja frekvens~n~~" .. radioConfig.Controls.ToggleClicks.Name .. "~ Är ~a~ Mikrofon klickar~n~Frekvens: ~1~ MHz" },
	{ "FRZL_RADIO_HELP2", "~s~" .. (radioConfig.Controls.Secondary.Enabled and "~" .. radioConfig.Controls.Secondary.Name .. "~ + ~" .. radioConfig.Controls.Activator.Name .. "~" or "~" .. radioConfig.Controls.Activator.Name .. "~") .. " Gömma.~n~~" .. radioConfig.Controls.Toggle.Name .. "~ Radio ~r~Av~s~.~n~~" .. radioConfig.Controls.Broadcast.Name .. "~ Sända.~n~Frekvens: ~1~ MHz" },
	{ "FRZL_RADIO_INPUT", "Ange frekvens" },
}
...
Radio.Commands = {
	...
	},
	{
		...
		Name = "Frekvens", -- Command name
		Help = "Byt radiofrekvens", -- Command help shown in chatbox when typing the command
		Params = {
	...
	while true do
		...
		if Radio.Open then
			...
			if not Radio.On then
				AddTextComponentSubstringPlayerName(Radio.Clicks and "~r~Av~w~" or "~g~På~w~")
			end
